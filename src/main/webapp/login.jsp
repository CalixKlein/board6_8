...
<!-- 		<h1>로그인</h1>
		...
		&nbsp;&nbsp;
		<a href="login.do?lang=rs"><spring:message code="message.user.login.language.rs"></spring:message></a>
		<hr>
		<form action="login.do" method="post">
			<table border="1" cellpadding="0" cellspacing="0">
				<tr>
				...
				<tr>
					<td colspan="2" align="center"><input type="submit"
						value="<spring:message code="message.user.login.loginBtn"></spring:message>" />
					</td>
				</tr>
			</table>
		</form>
